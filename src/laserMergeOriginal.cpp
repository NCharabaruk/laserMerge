...
void mergeScans(const sensor_msgs::LaserScan::ConstPtr& msg);
...
int main(int argc, char **argv)
{
	...
	//subscribed data
	ros::Subscriber laser1 = n.subscribe("scan1", 10, mergeScans);
	ros::Subscriber laser2 = n.subscribe("scan2", 10, mergeScans);
